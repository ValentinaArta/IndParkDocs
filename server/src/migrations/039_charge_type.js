...
module.exports = async function runMigration039(pool) {
  try {
    ...
    logger.info('Migration 039 applied: charge_type + one_time_amount added to contract + supplement');
  } catch (e) {
    logger.error({ msg: 'Migration 039 error', err: e.message });
    throw e;
  }
};
