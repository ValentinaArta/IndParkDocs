...
- **Группировка строк — новый UX** (2026-02-25): при выборе поля группировки таблица не перестраивается; выбранное поле превращается в заголовок колонки с выпадающим списком уникальных значений (фильтр-дропдаун). Нужно продумать взаимодействие с текущим `AGG_HIERARCHY_FIELDS` механизмом.
