...
## Планы / Next Steps
- Добавить оборудование в базу и проверить отчёты
- Phase 2 отчётов: оборудование у конкретных арендаторов через subject_of связь (когда договор явно ссылается на оборудование)
