...
| workshop | 🏭 | Цех |
| room | 🚪 | Помещение |
| land_plot | 🌍 | Земельный участок (новый) |
...
## 🚧 В обсуждении (не реализовано)
- **Иерархический list view** — tree вместо cross-tab (Корпус → Оборудование → ...)
  - Открытые вопросы: поля на листовом уровне, нужны ли колонки, отдельная вкладка или авто?
- **Анализ затрат оборудования** — пивот по ремонтам/обслуживанию, нужна clarification по данным

## Планы / Next Steps
- Дождаться ответов на вопросы по иерархическому list view, реализовать
- Добавить оборудование в базу и проверить отчёты "По связям"
- Phase 2 отчётов: оборудование у конкретных арендаторов через subject_of связь
- Консервация: линк оборудования на конкретный Приказ
- Множественные локации для оборудования (кабельные линии через несколько корпусов)
