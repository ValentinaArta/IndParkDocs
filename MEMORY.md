...
## Задеплоенный коммит
`a23082c` (main) — feat: full land_plot quick-create form + fuzzy company duplicate check (2026-02-26)
...
- **🔍 Поиск по субарендатору** ✅ (2026-02-26)
- **🔢 Автономер ДС** ✅ (2026-02-26)
- **🏛 Скрыть parent_id для компаний** ✅ (было реализовано ранее)
- **🏢 Inline-создание компании из договора** ✅ (было реализовано через "Другое...")
...
- **🚫 Защита от дублей компаний** ✅ (2026-02-26) — fuzzy check + confirm dialog
- **⏳ Индикатор загрузки (spinner)** ✅ (2026-02-26)
- **🔎 Поиск при выборе контрагента** ✅ (2026-02-26) — renderSearchableSelect
- **📊 Ставка НДС в ДС** ✅ (2026-02-26)
- **🌍 Quick-create ЗУ из формы корпуса** ✅ (2026-02-26) — inline panel с полями
- **📐 Площадь ЗУ — кв.м.** ✅ (2026-02-26) — migration 018
- **🏛 Собственник корпуса/ЗУ — только наши + поиск** ✅ (2026-02-26)
